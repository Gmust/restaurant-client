export const OrderInfoSkeleton = () => {
  return (
    <div className="bg-white p-4 border rounded-md border-black text-black flex flex-col items-center space-y-2 animate-pulse">
      ...
      <div className="grid grid-cols-2 gap-x-4">
        <div className="flex-col snap-y snap-mandatory">
          ...
          <div className="overflow-auto max-h-96 border-2 border-black bg-gray-200 w-full">
            {[1, 2, 3, 4].map((_, index) => (
              <div key={index} className="flex justify-between text-xl items-center bg-inherit shadow-md border-2 border-[#591d25] p-1 space-x-2 mb-2">
